...
const emptyForm: Record<string, string> = {
  courseId: "", topic: "", week: "", date: "", deadline: "", ta: "",
...
export default function AddHomeworkModal({ open, onClose, onSuccess }: AddHomeworkModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl border border-border bg-surface shadow-xl p-6">
        <h2 className="text-lg font-semibold text-foreground mb-4">新增 Homework</h2>
