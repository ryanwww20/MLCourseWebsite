  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-md px-4 py-16">
        ...
        <p className="text-sm text-muted mb-2">或使用以下方式登入</p>
        <div className="flex gap-3">
          <button
            type="button"
            onClick={() => signIn("google", { callbackUrl: "/home" })}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border border-border rounded-lg bg-background text-foreground hover:bg-muted/50 transition-colors"
